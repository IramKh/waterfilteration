...
def home(request):
	...
	if request.method=="POST":
		...
		#send an email
		send_mail('fname', 'msg', settings.EMAIL_HOST_USER, ['iramkhan20.ik@mail.com'], fail_silently=False, html_message=msg)
...
def contact(request):
	...
	if request.method=="POST":
		...
		ins=contact(name=fname,email=email, subject=subject, msg=message)
		ins.save()
